...
#                attach_to(), detach_from(), move_by()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center, defaults, fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            Draws anything that has been attached to the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            After everything has been drawn on the window. If it is called
# before, code intended for the window wont be shown. If it isn't called at
# all the window will never close.
#
